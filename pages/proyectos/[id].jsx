...
const Proyecto = ({proy}) => {
  ...
  return (
    ...
    <div className="flex">
      ...
      <h1 className='capitalize text-4xl mt-2 mb-8 text-center md:text-left font-bold text-black tracking-wider' >{proy.title}</h1>
      <div className="relative w-96 h-56 mx-auto overflow-hidden my-8">
        <Image src={proy.src} alt={proy.title} layout='fill' objectFit='cover'/>
      </div>
        ...
        <div className="flex items-center justify-center gap-10">
          {proy.deploy && <Button href={proy.deploy} text="demo" target={true} />}
          {proy.link &&  <Button href={proy.link} text="github" github={true} target={true} />}
